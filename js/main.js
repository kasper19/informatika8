...
(function () {
    ...
    $('body').on('click', (ev) => {
        if (ev.target.matches('.right img:not(.not-incresed)') || ev.target.matches('.hiddenEl img:not(.close-pop)') || ev.target.matches('.end img') || ev.target.matches('.end2 img') || ev.target.matches('.end23 img')) {
